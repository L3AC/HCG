...
const loadTemplate = async () => {
    ...
    if (DATA.session) {
        ...
        if (DATA.status) {
            if (DATA.dataset === 2) {
                // Si el dataset es 2, significa que deben cambiar la contraseña.
                sweetAlert(4, DATA.message, false);// Muestra un mensaje o redirige a la página de cambio de contraseña.
                //location.href = 'change_password.html';
                return;
            } else if (DATA.dataset === 1) {
