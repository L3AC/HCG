const tiempoInactividad = 1000000; // 1 minuto en milisegundos (total de inactividad permitida)
const tiempoAdvertencia = 500000; // 50 segundos en milisegundos (cuando se debe mostrar la advertencia)
