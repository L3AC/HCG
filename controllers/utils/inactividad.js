const tiempoInactividad = 10000; // 1 minuto en milisegundos (total de inactividad permitida)
const tiempoAdvertencia = 5000; // 50 segundos en milisegundos (cuando se debe mostrar la advertencia)
