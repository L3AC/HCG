        ...
        DATA.dataset.forEach(row => {
            ...
            TABLE_BODY.innerHTML += `
                <tr>
                    ...
                    <td>
                        <button type="button" class="btn" onclick="openUpdate(${row.id_rol})"  style="background-color: #AA6231;">
                        ...
                        <button type="button" class="btn" onclick="openDelete(${row.id_rol})" style="background-color: #AA6231;">
